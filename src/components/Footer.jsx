        ...
        <div className="footer-left">
          <div className="brand-container">
            <div className="logo-wrapper">
              <img src="/goods.png" alt="Hize Logo" className="footer-logo" />
              <span className="brand-name desktop-only">onnectify.global</span>
            </div>
          </div>
          <div className="social-links">
            ...
            <a
              href="https://www.instagram.com/connectify.global?igsh=eTJqamg0bjF2eDVy"
          ...
          <p className="copyright">
            © All Rights Reserved 2025. Connectify.global
          </p>
        </div>
