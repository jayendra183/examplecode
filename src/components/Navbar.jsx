...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? "flex" : "hidden"}`}>
        <Link to="/" className="text-white text-lg font-medium p-4">
          HOME
        </Link>
        <Link to="/about" className="text-white text-lg font-medium p-4">
          ABOUT US
        </Link>
        <Link to="/services" className="text-white text-lg font-medium p-4 flex items-center justify-between">
          OUR SERVICES
          <span className="dropdown-arrow">▼</span>
        </Link>
        <Link to="/why" className="text-white text-lg font-medium p-4">
          WHY HIZE?
        </Link>

        <div className="p-4 border-t border-white/10">
          <div className="search-box w-full mb-4">
          ...
          <button className="contact-btn w-full mb-4">Contact Us</button>
          <div className="language-select justify-center">
            <a href="#es" className="active">
              ES
            </a>
            <a href="#en">EN</a>
